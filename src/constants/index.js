...
export const FEATURED_PROJECTS = [
  ...
  },
  {
    ...
    tags: ["Python", "FastAPI", "React", "Optional Groq API", "Deterministic fallback", "Docker", "PostgreSQL"],
    desc: "Task planner that decomposes goals into 5 actionable steps, with optional Groq integration, task history, and PDF export. The public demo currently uses a deterministic fallback.",
    impact: "Docker Compose stack, admin auth, Postgres persistence, and a Vercel demo.",
  ...
  },
  {
    ...
    impact: "23 Vitest tests, Docker packaging, exponential backoff, and a GitHub Actions workflow.",
    live: null,
